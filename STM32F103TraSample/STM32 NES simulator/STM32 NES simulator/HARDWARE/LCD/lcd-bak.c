...
void LCD_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_7|GPIO_Pin_6|GPIO_Pin_5;     ///PORTC6~10复用推挽输出
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init(GPIOC, &GPIO_InitStructure); //GPIOC

    GPIO_SetBits(GPIOC,GPIO_Pin_4|GPIO_Pin_7|GPIO_Pin_6|GPIO_Pin_5);

    /*2018.12.29 增加端口D的初始化*/

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;      ///PORTC6~10复用推挽输出
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
