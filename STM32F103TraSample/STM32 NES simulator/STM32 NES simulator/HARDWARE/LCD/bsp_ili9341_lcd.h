...
#define      ILI9341_Window_X_Start        0           //起始点的X坐标
#define      ILI9341_Window_Y_Start        0           //起始点的Y坐标
...
/******************************* 定义 ILI934 常用命令 ********************************/
#define      CMD_SetAxisX                  0x2A        //设置矩形填充区域的X轴方向起止两点
#define      CMD_SetAxisY                  0x2B        //设置矩形填充区域的Y轴方向起止两点
